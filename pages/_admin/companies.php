            ...
            <?php foreach ($res as $row):?>
                <div class="company-item cart border w-75 p-1 my-1 bg-light">
                    ...
                    <div class="company_settings">
                        ...
                        data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="<?php echo $row['id'];?>"></i><br>
                        <label for="">Вариантов ответа: <?php echo $row['max_answers'] ?></label>
                        <i role="button" 
                        class="bi bi-pencil-fill text-primary button"
                        data-bs-toggle="modal" data-bs-target="#exampleModal3" data-bs-whatever="<?php echo $row['id'];?>"></i><br>
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="../../php/changeAnswersCount.php">
                        <input type="hidden" name="company_id" value="" class='company_id'>
                        <div class="mb-3">
                            <input type="text" name="max_answers" class="form-control" id="">
                        </div>
                        <button type="submit" class="btn btn-primary">Изменить</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Закрыть</button>
                    </form>
